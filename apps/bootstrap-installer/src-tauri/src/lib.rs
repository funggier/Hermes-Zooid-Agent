//! HermesZooid Setup — Tauri entrypoint.
//!
...
/// desktop app handing off via `HermesZooid-Setup.exe --update`).
///
    ...
    tauri::Builder::default()
        ...
        .setup(move |app| {
            ...
            if cfg!(target_os = "macos") && mode == AppMode::Install && !force_setup {
                let install_root = paths::hermes_home().join("app");
        ...
        .expect("error while running HermesZooid Setup");
}

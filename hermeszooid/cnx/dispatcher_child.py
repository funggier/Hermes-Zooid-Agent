"""Child entrypoint for the HermesZooid-owned dispatcher process boundary."""
...
def _parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(prog="python -m hermeszooid.cnx.dispatcher_child")
...
def _validate_process_identity(db_path: Path, board: str) -> None:
    ...
    hermeshermeszooid_home = (os.environ.get("HERMESZOOID_HOME") or "").strip()

    if not hermeshermeszooid_home:

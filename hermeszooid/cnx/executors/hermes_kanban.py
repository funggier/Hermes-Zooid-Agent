...
surface beneath HermesZooid-owned storage.
"""
...
class HermesKanbanExecutor:
    ...
    def __init__(
        ...
        *,
        db_path: Path | str,
        hermeszooid_home: Path | str | None = None,
        ...
        home_value = hermeszooid_home or os.environ.get("HERMESZOOID_HOME") or self.db_path.parent
        self.hermeszooid_home = Path(home_value).expanduser().resolve()
    ...
    def worker_env(self) -> dict[str, str]:
        """Environment required to keep Hermes Kanban runtime state HermesZooid-owned."""
        return {
            "HERMES_KANBAN_HOME": str(self.hermeszooid_home),

...
**สถานะโครงการ: PAUSED_BY_USER** ผู้ใช้จะทำ CogentNexus-OpenClaw ให้เสร็จก่อน
เอกสารนี้เตรียมไว้ให้กลับมาต่อ ไม่มีการเริ่มงาน/ส่งงาน/ติดตามสถานะอัตโนมัติ
ต้องมีคำสั่งจากผู้ใช้ให้กลับมาพัฒนา Zooid ก่อนรับ task
